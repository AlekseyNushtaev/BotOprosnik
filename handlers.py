...
Чтобы начать проверку, жмите на кнопку👇🏻
        ...
        reply_markup=create_kb(1,
                               step_1="✅Пройти проверку",
                               gaid='Гайд "Как найти деньги на банкротство?"',
                               bonus='Хочу бонус за рекомендацию')
    )
...
async def bonus(cb: CallbackQuery):
    keyboard = types.InlineKeyboardMarkup(inline_keyboard=[
        ...
        [types.InlineKeyboardButton(
            ...
            url="https://urstarts.ru/affiliate"
        )],
        # Колбек-кнопки
        [
            types.InlineKeyboardButton(
        ...
        [
            types.InlineKeyboardButton(
                text='Гайд "Как найти деньги на банкротство?"',
                callback_data="gaid"
            )
        ]
    ])
    await cb.message.answer(text="""
💼 Зарабатывайте с Партнёрской программой ЮК «Старт»!  

Помогите вашим знакомым получить профессиональные юридические услуги, а вы получите до 10 000 рублей за каждого нового клиента.  

📌 Как это работает?  
— Рекомендуйте нашу компанию коллегам, партнёрам и знакомым.  
— Получайте денежное вознаграждение без ограничений по количеству привлечённых клиентов.  

🚀 Для участия:  
✅ Переходите по ссылке и заполните форму 👉 https://urstarts.ru/affiliate

Присоединяйтесь к нашей партнёрской программе и начните зарабатывать с профессионалами!    
    """,
                            parse_mode=ParseMode.HTML,
...
Выберите подходящий вам вариант из списка ниже, нажав на него👇 
        """,
                            parse_mode=ParseMode.HTML,
                            reply_markup=create_kb(1,
                                                   step_2_no="Менее 400 тыс.",
                                                   step_2_1_yes="400-600 тыс.",
                                                   step_2_2_yes="600 тыс.- 1 млн.",
...
async def step_2_no(cb: CallbackQuery):
    await cb.message.answer(text="Правильно понимаю, что если суммировать все ваши долги, кредиты и займы с процентами, штрафами и пенями, то все равно будет <b>менее 300 тыс. рублей?</b>",
                            parse_mode=ParseMode.HTML,
                            reply_markup=create_kb(1,
                                                   step_2_2_no="Да, менее 400 тыс.",
                                                   step_2_4_yes="Более 400 тыс."
                                                   ))
